...
public interface IHasWorld extends org.archstudio.bna.IThing {
	public static final IThingKey<org.archstudio.bna.IBNAWorld> WORLD_KEY = ThingKey
			.create(com.google.common.collect.Lists.newArrayList("world", IHasWorld.class), true);
