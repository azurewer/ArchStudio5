...
public interface IHasArrowheads extends org.archstudio.bna.IThing {
	...
	public static final IThingKey<java.lang.Integer> ARROWHEAD_1_LENGTH_KEY = ThingKey
			.create(com.google.common.collect.Lists.newArrayList("arrowhead1Length", IHasArrowheads.class));

	public static final IThingKey<org.archstudio.bna.constants.ArrowheadShape> ARROWHEAD_1_SHAPE_KEY = ThingKey
			.create(com.google.common.collect.Lists.newArrayList("arrowhead1Shape", IHasArrowheads.class));

	public static final IThingKey<java.lang.Integer> ARROWHEAD_1_WIDTH_KEY = ThingKey
			.create(com.google.common.collect.Lists.newArrayList("arrowhead1Width", IHasArrowheads.class));
	...
	public static final IThingKey<java.lang.Integer> ARROWHEAD_2_LENGTH_KEY = ThingKey
			.create(com.google.common.collect.Lists.newArrayList("arrowhead2Length", IHasArrowheads.class));

	public static final IThingKey<org.archstudio.bna.constants.ArrowheadShape> ARROWHEAD_2_SHAPE_KEY = ThingKey
			.create(com.google.common.collect.Lists.newArrayList("arrowhead2Shape", IHasArrowheads.class));

	public static final IThingKey<java.lang.Integer> ARROWHEAD_2_WIDTH_KEY = ThingKey
			.create(com.google.common.collect.Lists.newArrayList("arrowhead2Width", IHasArrowheads.class));
