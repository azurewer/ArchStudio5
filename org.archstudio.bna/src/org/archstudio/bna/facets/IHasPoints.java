...
public interface IHasPoints extends org.archstudio.bna.IThing {
	public static final IThingKey<java.util.List<java.awt.geom.Point2D>> POINTS_KEY = ThingKey
			.create(com.google.common.collect.Lists.newArrayList("points", IHasPoints.class));
