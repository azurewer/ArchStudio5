...
public interface IHasRotatingOffset extends org.archstudio.bna.IThing {
	 ...
	 * call {@link #incrementRotatingOffset()} for things that are not selected,
	 * e.g., {@link RectangleThing}. Conversely,
	...
	public static final IThingKey<java.lang.Integer> ROTATING_OFFSET_KEY = ThingKey
			.create(com.google.common.collect.Lists.newArrayList("rotatingOffset", IHasRotatingOffset.class));
