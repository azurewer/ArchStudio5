...
public interface IHasColor extends org.archstudio.bna.IThing {
	public static final IThingKey<org.eclipse.swt.graphics.RGB> COLOR_KEY = ThingKey
			.create(com.google.common.collect.Lists.newArrayList("color", IHasColor.class), true);
