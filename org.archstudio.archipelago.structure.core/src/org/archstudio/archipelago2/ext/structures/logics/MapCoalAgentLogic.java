...
public class MapCoalAgentLogic extends MapBrickLogic {
	public MapCoalAgentLogic(IBNAWorld world, IXArchADT xarch, ObjRef rootObjRef, String objRefPath,
		      String mappingDescription) {
		    super(world, xarch, rootObjRef, objRefPath, 3, new Dimension(144, 96), mappingDescription);
		  }

		  @Override
		  public void applyDefaults(RectangleThing thing) {
		    super.applyDefaults(thing);
		    thing.setColor(StructurePreferences.getCoalAgentColor());
		  }
		  ...
		  public void applyPreferences(RectangleThing thing) {
		    ...
		    FontData labelFont = StructurePreferences.getCoalAgentFont();
