...
public class MapEncapsulatedUnitLogic extends MapBrickLogic {

	public MapEncapsulatedUnitLogic(IBNAWorld world, IXArchADT xarch, ObjRef rootObjRef, String objRefPath,
		      String mappingDescription) {
		    super(world, xarch, rootObjRef, objRefPath, 5, new Dimension(144, 96), mappingDescription);
		  }

		  @Override
		  public void applyDefaults(RectangleThing thing) {
		    super.applyDefaults(thing);
		    thing.setColor(StructurePreferences.getEncapsulatedUnitColor());
		  }
		  ...
		  public void applyPreferences(RectangleThing thing) {
		    ...
		    FontData labelFont = StructurePreferences.getEncapsulatedUnitFont();
